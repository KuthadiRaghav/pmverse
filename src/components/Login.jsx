...
import { LogIn, Key, Mail, Compass } from 'lucide-react';
    ...
    <div style={{
      ...
      >
        ...
        <p style={{ color: secondaryText, margin: '0 0 32px 0', fontSize: '15px' }}>
          Sign in to access your PMverse OS
        </p>
        ...
        <div style={{ display: 'flex', alignItems: 'center', width: '100%', margin: '24px 0', gap: '12px' }}>
          ...
          <span style={{ color: secondaryText, fontSize: '13px', fontWeight: 500 }}>OR</span>
          <div style={{ height: '1px', flex: 1, backgroundColor: borderColor }} />
        </div>
        ...
        <p style={{ marginTop: '24px', fontSize: '14px', color: secondaryText }}>
